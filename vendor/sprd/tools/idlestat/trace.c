...
int idlestat_disable_dynamic_cpumask(bool enable)
{
	return write_int(DYNAMIC_CPUMASK_PATH, enable);
}
 ...
 */
	...
	/* Enable irq traces */
	write_int(TRACE_IRQ_EVENT_PATH, 1);
/*
